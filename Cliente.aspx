<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cliente.aspx.vb" Inherits="GrupoModeloWEB.Cliente" %>
...
<body class="fondopag">
    ...
    <form id="form1" runat="server">
        ...
        <table  border="0" class="link">
            <tr>
            <td>
        <asp:Label ID="Label1" runat="server" Text="Clave de cliente : "></asp:Label>
                </td>
                <td colspan = "2">
        <asp:TextBox ID="txt_id_cli" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
        <asp:Label ID="Label2" runat="server" Text="Nombre : "></asp:Label>
                ...
                <td colspan = "2">
        <asp:TextBox ID="txt_nom_cli" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
        <asp:Label ID="Label3" runat="server" Text="Ubicación : "></asp:Label>
                ...
                <td colspan = 2>
                    <asp:TextBox ID="txt_ubi_cli" runat="server"></asp:TextBox>
                </td>
            </td>
            <tr>
                <td>
        <asp:Label ID="Label4" runat="server" Text="Teléfono : "></asp:Label>
                ...
                <td colspan = 2>
                    <asp:TextBox ID="txt_tel_cli" runat="server"></asp:TextBox>
                </td>
                </td>
            </tr> 
                <td align = "center"   >
        ...
        <asp:GridView ID="Grid_Cli" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" DataKeyNames="RFC_CLI,NOM_CLI,UBI_CLI,TEL_CLI" class="link">
