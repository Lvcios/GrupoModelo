<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Producto.aspx.vb" Inherits="GrupoModeloWEB.Producto" %>
...
<body class="fondopag">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Text="Clave de producto : "></asp:Label>
                ...
                <td colspan = "2">
        <asp:TextBox ID="txt_id_pro" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
        <asp:Label ID="Label2" runat="server" Text="Nombre : "></asp:Label>
                ...
                <td colspan = "2">
        <asp:TextBox ID="txt_nom_pro" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <asp:Label ID="Label4" runat="server" Text="Precio : "></asp:Label>
                ...
                <td colspan = 2>
                    <asp:TextBox ID="txt_pre_pro" runat="server"></asp:TextBox>
                </td>
            </tr> 
            <tr>
                <td align = "center"   >
        ...
        <asp:GridView ID="Grid_Pro" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" DataKeyNames="ID_PRO,NOM_PRO,PRE_PRO" class="link">
